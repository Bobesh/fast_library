...
def log_warning(logger: logging.Logger, message: str, exc_info: Exception = None, **kwargs: Any) -> None:
    logger.warning(message, exc_info=exc_info, extra=kwargs)

def log_error(logger: logging.Logger, message: str, exc_info: Exception = None, **kwargs: Any) -> None:
